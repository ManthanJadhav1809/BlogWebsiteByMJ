...
import { collection, deleteDoc, doc, getDocs, increment, serverTimestamp, updateDoc } from 'firebase/firestore';
        ...
        <div key={post.id} className="Post-card">
          ...
          <img className='postImage' src={post.imageUrl} alt="PostImage" />
            ...
            <div className="postButtons">
              ...
              <button><Link to={`/UpdatePost/${post.id}`}>Update</Link></button>
              <button><Link to={`/UpdatePost/${post.id}`}>Update</Link></button>
              </>
             }
